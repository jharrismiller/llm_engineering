...
MODEL = os.getenv("OPENROUTER_GEMINI_MODEL")
...
Provide detailed feedback and scores from 1 (very poor) to 5 (ideal) for each dimension. If the answer is wrong, then the accuracy score must be 1.""",
    ...
    judge_response = completion(model=f'openrouter/{MODEL}', base_url=base_url, api_key=api_key, messages=judge_messages, response_format=AnswerEval)
